...
void total_fireBOT(char hit, char grid[10][10], int *sunkShips, int *smokeScreen, bool *recentSunk, bool *Submarine, bool *Destroyer, bool *BattleShip, bool *Carrier, bool *recentHit, bool *recentHit2)
{
    if (hit != '~')
    {
        if (isSunk(hit, grid))
